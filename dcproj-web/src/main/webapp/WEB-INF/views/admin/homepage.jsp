...
<head>
  ...
  <script type="text/javascript" src="${ctx}/static/js/custom/dashboard.js"></script>
  ...
  <div class="topheader">
    ...
    <div class="right">
      ...
      <div class="userinfo">
        ...
        <span><shiro:guest>游客</shiro:guest><shiro:user><shiro:principal property="username"/></shiro:user></span>
      </div><!--userinfo-->
      ...
      <div class="userinfodrop">
        ...
        <div class="userdata">
          <shiro:user>
            <h4>欢迎你 <strong class="username"><shiro:principal property="username"/></strong>  </h4>
          ...
          <shiro:guest>
            <h4>游客</h4>
            <span class="warning">你还没有登录</span>
            <a href="${ctx}/login">点击登录</a>
          </shiro:guest>
        </div><!--userdata-->
      </div><!--userinfodrop-->
    </div><!--right-->
...
--%>
  ...
  <div class="vernav2 iconmenu">
    <ul >
      <li><a href="" class="editor">系统管理</a> </li>
                ...
                <ul class="entrylist">
                  <li>
                    <div class="entry_wrap">
                      <div class="entry_img"><img src="${ctx}/static/images/thumbs/image1.png" alt=""/></div>
                  ...
                  <li class="even">
                    <div class="entry_wrap">
                      <div class="entry_img"><img src="${ctx}/static/images/thumbs/image2.png" alt=""/></div>
                      <div class="entry_content">
                  ...
                  <li>
                    <div class="entry_wrap">
                      <div class="entry_img"><img src="${ctx}/static/images/thumbs/image3.png" alt=""/></div>
                      <div class="entry_content">
                  ...
                  <li class="even">
                    <div class="entry_wrap">
                      <div class="entry_img"><img src="${ctx}/static/images/thumbs/image4.png" alt=""/></div>
                      <div class="entry_content">
        ...
        <div class="one_third last dashboard_right">
          ...
          <div class="widgetbox">
            ...
            <div class="widgetcontent userlistwidget nopadding">
              <ul>
                <li>
                  <div class="avatar"><img alt="" src="${ctx}/static/images/thumbs/avatar1.png"/></div>
                  <div class="info">
                    <a href="">Squint</a> <br/>
                ...
                <li>
                  <div class="avatar"><img alt="" src="${ctx}/static/images/thumbs/avatar2.png"/></div>
                  <div class="info">
                    <a href="">Eunice</a> <br/>
