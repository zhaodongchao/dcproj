package org.dongchao.security.web.authentication;
 ...
 * 自定义登录异常切入点，会被ExceptionTranslationFilter（捕获身份信息认证时的异常）引用
 * 在出现认证异常、访问异常时，通过入口点决定redirect、forward的操作
 * Created by zhaodongchao on 2017/5/28.
 */
public class UnAuthenticationEntryPoint implements AuthenticationEntryPoint {
    private static final Log logger = LogFactory.getLog(UnAuthenticationEntryPoint.class);
    // ~ Instance fields
    // ================================================================================================
